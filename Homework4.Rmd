...
ggplot(chi_square_jury, aes(x = result)) +
  ...
  labs(x = "Simulated Chi-Square Statistic",
       y = "Number of Simulations",
       title = "Simulated Dist. of Chi-Square Stats Under Expected Jury Group Distribution")
```
...
ggplot(chi_stat_null, aes(x = X27.5691416584961)) +
  ...
  labs(x = "Chi-Square Statistic",
       ...
       title = "Chi-Square Dist. of Brown Corpus Sentences Against English Letter Dist.")
```
...
The sentence generated and watermarked by an LLM was most likely sentence 6. This is because it has the lowest p-value of all ten sentences, indicating the probability that the sentence's letter distribution or a letter distribution more extreme than that occurring by chance assuming that all of the above sentences were human-written and not generated by an LLM was 0.132.
